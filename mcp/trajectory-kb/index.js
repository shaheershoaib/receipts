  ...
  tools: [
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          surface: { type: "string", description: "Component/route/graphify node the work touched (free human text)." },
          ...
          files: { type: ["string", "array"], items: { type: "string" }, description: "Files the fix edited - feeds history-aware fanout-plan tiering (string or list)." },
          regressed: { type: ["string", "array"], items: { type: "string" }, description: "Other surfaces/files this fix BROKE - the 'fixing A broke B' coupling signal for fanout-plan (string or list)." },
